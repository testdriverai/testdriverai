...
<Steps>
<Step title="Understand the mapping">
...
<Step title="Extract steps from Gherkin">
...
<Step title="Write the prompts in YAML format">
...
<Step title="Run the test with TestDriver">
