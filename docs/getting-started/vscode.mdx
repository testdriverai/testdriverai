---
title: "Install the TestDriver VSCode Extension"
sidebarTitle: "VSCode Extension"
description: "Comprehensive guide to installing and setting up TestDriver for VSCode"
icon: "file-code"
---

# Download the VSCode Extension

The TestDriver VSCode extension is available for download on our GitHub releases page. This extension integrates seamlessly with Visual Studio Code, allowing you to leverage the power of TestDriver directly within your development environment.
...
>
  Get the latest version of the TestDriver VSCode extension from our GitHub releases page. 
</Card>
...
<Frame caption="VSCode Extension Overview">
...
<Frame caption="The test pane is here">
   <img height="200" src="/images/content/vscode/vscode-testpane.png" /> 
</Frame>
...
<Frame caption="AI Agent Test Preview">
    <img height="200" src="/images/content/vscode/vscode-agent-preview.png" />
</Frame>
...
<Frame caption="More history, less mystery">
    <img height="200" src="/images/content/vscode/vscode-testhistory.png" />
</Frame>
