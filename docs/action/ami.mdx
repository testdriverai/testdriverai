...
<Steps>
  ...
  <Step title="Connect to Your TestDriver Instance">
    After setting up your TestDriver instance:

    1. **Get the IP address** of your running TestDriver instance.
    2. Connect directly to your instance using the TestDriver CLI:

    ```bash
    testdriverai --ip=192.168.1.100
    ```

    This instructs the CLI to connect directly to your TestDriver instance at the specified IP address.
