---
title: Overview of the TestDriver.ai CLI
sidebarTitle: "CLI Overview"
description: "Learn about the TestDriver.ai CLI, its commands, and how to use it effectively."
icon: "terminal"
---
# TestDriver.ai CLI Overview
The TestDriver.ai CLI is a powerful tool designed to streamline the process of creating, managing, and executing automated tests. It provides a user-friendly interface for developers and testers to interact with the TestDriver.ai framework.
