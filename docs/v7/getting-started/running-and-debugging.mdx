...
📹 Dashcam Replays:
  - https://app.testdriver.ai/dashcam/abc123
  - https://app.testdriver.ai/dashcam/def456
```
...
<Steps>
  ...
  <Step title="Open Replay">
    Visit [app.testdriver.ai](https://app.testdriver.ai) or click the URL directly.
  </Step>
...
<Steps>
  <Step title="Get Dashcam URL">
    ...
    ```
    Tests failed!
    Dashcam replay: https://app.testdriver.ai/dashcam/abc123
    ```
  </Step>
