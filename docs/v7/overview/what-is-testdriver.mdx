...
TestDriver enables software teams to easily test, debug, and monitor E2E user flows that are typically hard or impossible to cover with other testing tools.

## Built for Complex Software

Most testing tools work fine for simple web apps. But real software is complex:

<CardGroup cols={2}>
  <Card title="Desktop Applications" icon="desktop">
    Electron apps, Tauri apps, native desktop software. Clone, build, and test any desktop application.
  </Card>
  <Card title="Browser Extensions" icon="puzzle-piece">
    Chrome extensions, Firefox add-ons, and other browser plugins that traditional tools can't touch.
  </Card>
  <Card title="Multi-Window Flows" icon="window-restore">
    OAuth popups, payment modals, third-party auth flows that span multiple windows and domains.
  </Card>
  <Card title="Complex UI Elements" icon="layer-group">
    Canvas, WebGL, iframes, video players, and shadow DOM that trip up selector-based tools.
  </Card>
</CardGroup>

TestDriver handles all of these because it works the way a human does — by looking at the screen and using keyboard and mouse.
