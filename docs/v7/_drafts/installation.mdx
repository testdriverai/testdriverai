...
<Note>
  **Fastest Way to Get Started:** Use `testdriverai init` to scaffold a complete project automatically:
  ...
  This creates everything you need: package.json, test files, Vitest config, GitHub Actions workflow, and prompts for your API key. Then just run `npx vitest run`!
