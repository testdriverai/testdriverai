...
<ParamField path="options" type="object | number">
  ...
  <Expandable title="properties">
    ...
    <ParamField path="cacheThreshold" type="number" default={0.05}>
      **Deprecated.** Use `cache.thresholds.screen` instead. Similarity threshold (0-1) for cache matching. Lower values require more similarity. Set to -1 to disable cache.
    </ParamField>

    <ParamField path="cache" type="object">
      Cache configuration for this call

      <Expandable title="properties">
        <ParamField path="cache.thresholds" type="object">
          <Expandable title="properties">
            <ParamField path="cache.thresholds.screen" type="number" default={0.01}>
              Pixel diff threshold (0-1). Lower values require more screen similarity. 0.01 = 1% diff allowed.
            </ParamField>
            <ParamField path="cache.thresholds.element" type="number" default={0.8}>
              OpenCV template match threshold (0-1). Higher values require more element similarity. 0.8 = 80% correlation required.
            </ParamField>
          </Expandable>
        </ParamField>
      </Expandable>
...
// Strict screen threshold - 99.5% similarity required
await testdriver.find('submit button', {
  cache: {
...
// Combine cacheKey with thresholds
await testdriver.find('submit button', {
  cacheKey: 'submit-btn',
  cache: {
    thresholds: { screen: 0.01, element: 0.8 }
  }
});
```
...
<ParamField path="options" type="object | number">
  ...
  <Expandable title="properties">
    ...
    <ParamField path="cacheThreshold" type="number" default={-1}>
      **Deprecated.** Use `cache.thresholds.screen` instead. Similarity threshold (0-1) for cache matching. Set to -1 to disable cache.
    </ParamField>
    ...
    <ParamField path="cache" type="object">
      ...
      <Expandable title="properties">
        <ParamField path="cache.thresholds" type="object">
          <Expandable title="properties">
            <ParamField path="cache.thresholds.screen" type="number" default={0.01}>
              Pixel diff threshold (0-1). Lower values require more screen similarity.
            </ParamField>
          </Expandable>
        </ParamField>
      </Expandable>
