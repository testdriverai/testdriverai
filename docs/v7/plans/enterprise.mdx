...
For organizations with the strictest security requirements and need for complete customization, TestDriver Enterprise provides a fully air-gapped solution with dedicated support.
...
Unlike [Self-Hosted](/v7/plans/self-hosted) (which uses TestDriver's hosted dashboard and API), Enterprise deploys everything in your environment:
