...
test('with automatic replay', async (context) => {
  ...
  // Output: https://app.testdriver.ai/dashcam/abc123def456
});
```
      ...
      "testResults": [
        {
          ...
          "status": "passed",
          "duration": 12345,
          "dashcamUrl": "https://app.testdriver.ai/dashcam/abc123",
          "assertions": 3
        }
      ]
    }
  ...
  <Tab title="JUnit XML">
    ...
    <testsuite name="login.test.js" tests="3" failures="0">
      <testcase name="user can login" time="12.345">
        <system-out>
          Dashcam: https://app.testdriver.ai/dashcam/abc123
        </system-out>
      </testcase>
    </testsuite>
    ```
...
View test analytics at [app.testdriver.ai](https://app.testdriver.ai):
