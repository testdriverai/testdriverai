...
title: "Vercel"
sidebarTitle: "Vercel"
description: "Integrate TestDriver.ai with Vercel deployments using GitHub Actions."
icon: "cloud"
---
...
The `prompt` field in the TestDriver.ai action specifies the steps to test the Vercel deployment. For example:
