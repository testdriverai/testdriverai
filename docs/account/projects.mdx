...
<Info>
The project ID can be used in conjunction with your `lifecycle/postrun.yaml` script to automatically assign a replay to a project. For more info see the (Dashcam section)[/guide/dashcam].
</Info>
<Frame caption="Click a Project to view its replays">
