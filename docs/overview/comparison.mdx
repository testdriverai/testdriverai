...
<div className="comparison-table">
  ...
  :---------: | :---------: | :-------: | | Test Generation | ✅ | | | |
  Adaptive Testing | ✅ | | | | Visual Assertions | ✅ | | | | Self Healing | ✅
  | | | | Application Switching | ✅ | | | | GitHub Actions | ✅ | ✅ | | | Team
...
<div className="comparison-table">
  | Feature | TestDriver | Playwright | Selenium | | :----------------- |
  :---------: | :---------: | :-------: | | AI Summary | ✅ | | | | Video Replay
  | ✅ | ✅ | | | Browser Logs | ✅ | ✅ | | | Desktop Logs | ✅ | | | | Network
  Requests | ✅ | ✅ | | | Team Dashboard | ✅ | | | | Team Collaboration | ✅ |
  | |
</div>
