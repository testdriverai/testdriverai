...
<Tip>
If you are unable to land on an accurate description or experiencing flaky results, try to upload the image to [chatgpt](https://chatgpt.com) and ask it to describe the image and use the generated `description` to get better accuracy and determinism.
</Tip>
