...
<Warning>There is a breaking change in v5 that updates the syntax of `press-keys`. See Example usage below and if you are not sure which version you are running, see [Checking the version](/cli/overview#checking-the-version)</Warning>
...
## Gotchas
- The syntax of the `press-keys` command differs from `v4` to `v5`. Make note of which version you are using and write commands accordlingly.
