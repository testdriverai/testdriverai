...
## Description
The `exec` command allows you to execute custom Node.js scripts within your TestDriver.ai tests. This is useful for tasks like generating dynamic data, interacting with APIs, or performing custom logic during a test. The output of the script can be stored in a variable for use in subsequent steps.
...
- Overwrite the `result` variable in your script, as it's used to store the output.
