...
async function main() {
  ...
  try {
    ...
    const outputPathWithMouse = path.join(__dirname, 'example-screenshot-with-mouse.png');
    fs.writeFileSync(outputPathWithMouse, Buffer.from(screenshotWithMouse, 'base64'));
