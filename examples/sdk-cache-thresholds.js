...
(async () => {
  try {
    ...
    const heading3 = await client.find('heading that says Example Domain', 0.01);
    ...
    const paragraph = await client.find('paragraph with text about illustrative examples');
    ...
    const paragraph2 = await client.find('paragraph with text about illustrative examples');
