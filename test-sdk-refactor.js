...
async function test() {
  ...
  console.log('  - agent.exploratoryLoop exists:', typeof client.agent.exploratoryLoop);
  console.log('  - agent.buildEnv exists:', typeof client.agent.buildEnv);
  console.log('  - agent.getRecentSandboxId exists:', typeof client.agent.getRecentSandboxId);
