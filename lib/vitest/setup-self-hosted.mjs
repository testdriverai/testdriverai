...
// Initialize the thread-safe global AWS object (shared with setup-aws.mjs)
const awsGlobal = ensureAWSGlobal(testInstances);
...
beforeEach(async (context) => {
  ...
  try {
    ...
    // Store instance info for this test (use shared global's map)
    awsGlobal.instances.set(testId, { publicIp, instanceId, awsRegion });
