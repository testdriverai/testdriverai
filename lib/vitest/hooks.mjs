...
function setupConsoleSpy(client, taskId) {
  ...
  const forwardToSandbox = (args) => {
    ...
    process.stdout.write(client.sandbox.instanceSocketConnected ? `[TestDriver Console Spy] Sandbox is connected` : `[TestDriver Console Spy] Sandbox is NOT connected`);
