      ...
      try {
        ...
        if (testdriver._dashcam && testdriver._dashcam.recording) {
          try {
            ...
            // Include sandbox ID for linking to TdSandbox records
            context.task.meta.sandboxId = testdriver.instance?.sandboxId || testdriver.instance?.instanceId || testdriver.agent?.sandboxId || null;
