...
export function TestDriver(context, options = {}) {
  ...
  const cleanup = async () => {
    ...
    try {
      ...
      // Kill E2B sandbox if one was spawned for this test
      if (globalThis.__testdriverE2B?.killSandbox) {
        await globalThis.__testdriverE2B.killSandbox(context.task.id);
      }
    }
  };
