...
export function TestDriver(context, options = {}) {
  if (!isMainThread) {
    throw new Error(
      'TestDriver requires pool: "forks" in your Vitest config. ' +
      'Thread-based pools ("threads", "vmThreads") are not supported. ' +
      'Either remove the pool option or set pool: "forks". ' +
