...
\`\`\``
    ...
    switch(object.command) {
      ...
      case 'click':
        ...
        log('info', generator.jsonToManual(object));
        notify(generator.jsonToManual(object, false))
        response = await commands['click'](object.x, object.y, object.button, object.click);
        break;
      case 'hover':
        speak(`moving mouse`);
        log('info', generator.jsonToManual(object));
      ...
      case 'hover-text':
        ...
        log('info', generator.jsonToManual(object));
        notify(generator.jsonToManual(object, false))
        response = await commands['hover-text'](object.text, object.description, object.action, object.method);
        break;
      case 'hover-image':
        speak(`searching for image of ${object.description}`);
        log('info', generator.jsonToManual(object));
        response = await commands['hover-image'](object.description, object.action);
        break;
      case 'match-image':
        log('info', generator.jsonToManual(object));
        notify(generator.jsonToManual(object, false))
        response = await commands['match-image'](object.path, object.action, object.button, object.click);
        break;
      case 'wait-for-image':
        speak(`waiting for ${object.description}`);
        log('info', generator.jsonToManual(object));
        notify(generator.jsonToManual(object, false))
        response = await commands['wait-for-image'](object.description, object.timeout);
        break;
      case 'wait-for-text':
        ...
        response = await commands['wait-for-text'](object.text, object.timeout, object.method);
        break;
      case 'scroll-until-text':
        ...
        copy.text = '*****'
        notify(generator.jsonToManual(copy, false))
        response = await commands['scroll-until-text'](object.text,  object.direction, object.distance, object.method);
        break;
      case 'scroll-until-image':
        speak(`scrolling until ${object.description}`);
        log('info', generator.jsonToManual(object));
        notify(generator.jsonToManual(object, false))
        response = await commands['scroll-until-image'](object.description, object.direction, object.distance);
        break;
