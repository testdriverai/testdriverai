...
module.exports = async () => {
  ...
  const response = await prompts(
    [
      ...
      /**
       * Skip this question so we always default to `.env` via prompts.override.
       * This may be re-enabled in the future, pending customer feedback.
       *
       * @see https://github.com/terkelg/prompts?tab=readme-ov-file#type
       */
      {
        type: null,
        name: "APPEND",
  ...
  // Default `APPEND` to `.env` (since it's skipped in prompts)
  response.APPEND = ".env";
