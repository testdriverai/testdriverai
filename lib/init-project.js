...
`;
    ...
    if (agentsSourceDir) {
      ...
      // Only copy agents to .github/agents/ if the directory already exists
      // (i.e. for existing projects that already use agent files)
      ...
      // Default: set testdriver.md as copilot-instructions.md
