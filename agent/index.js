...
\`\`\``,
  ...
  async run(file = this.thisFile, shouldSave = false, shouldExit = true) {
    ...
    try {
      ...
      this.emitter.emit(events.test.success, {
        filePath: file,
        duration: testDuration,
        timestamp: testEndTime,
      });

      // Emit test stop event
      this.emitter.emit(events.test.stop, {
        filePath: file,
        duration: testDuration,
        success: true,
        timestamp: testEndTime,
      ...
      this.emitter.emit(events.test.error, {
        filePath: file,
        error: error.message,
        duration: testDuration,
        timestamp: testEndTime,
      ...
      // Emit test stop event for failed test
      this.emitter.emit(events.test.stop, {
        filePath: file,
        duration: testDuration,
        success: false,
