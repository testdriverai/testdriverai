 ...
 * 
 * Original test: Navigate to https://developer.mozilla.org/en-US/docs/Web/HTML and scroll
 */
...
async function main() {
  ...
  try {
    ...
    // Step 2: scroll down with the mouse 1000 pixels
    console.log('\n📜 Scrolling down 1000 pixels...');
