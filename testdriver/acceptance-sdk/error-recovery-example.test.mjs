...
describe('Error Recovery Example', () => {
  ...
  beforeAll(async () => {
    ...
    healingClient = withErrorRecovery(client, {
      ...
      onRecovery: async (error, commandInfo, errorCount) => {
        console.log(`\n🔄 Recovery attempt ${errorCount} for ${commandInfo.method}`);
      }
    });
  });
  ...
  //     console.log(`   📝 Retrieved password: ${password ? '***' : 'none'}`);
  //   });
  ...
  it('should auto-recover from errors with AI', async () => {
    ...
    console.log('\n🔬 Testing with AI error recovery enabled...\n');
    console.log('💡 If commands fail, AI will suggest fixes and rewrite this file\n');
